...
return<>
 <div className="img-ctr">
    {cid && <a href={`https://eu.starton-ipfs.com/ipfs//${cid}`}><img src={`https://eu.starton-ipfs.com/ipfs//${cid}`} height={"250px"} /></a>}
    </div>
    <div className="transaction">
     {transaction && <a href={`https://testnet.bscscan.com/tx/${transaction}`}>Transaction Details</a>}
</div>
 <div className="form">
